...
`DevolutionsTerminal.icns` directly from the original transparent
`assets/icons/terminal.png` artwork, ad-hoc signs the bundle, and writes a zip
plus SHA-256 manifest.
